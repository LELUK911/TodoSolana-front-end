...
export const SetOffTodo = () => {
    const [srcTitle, setSrcTitle] = useState("")
    const setOffTransaction = async () => {
        try {
            ...
            const txHashsetoff = await program.methods
                .turnOffElement(srcTitle)
                .accounts({
            ...
            alert(`Transactio submit ${txHashsetoff}`)
    ...
    return (
        <div className='mt-px'>
            ...
            <button onClick={()=>{setOffTransaction()}} className="font-bold rounded-lg text-lg  w-48 h-16 bg-[#374151] text-[#ffffff] justify-center">Sett Off Todo</button>
        </div>
    )
}
